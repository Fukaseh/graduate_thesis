...
\subsection{資産の分布と資産変動の分布}
資産の相補累積分布関数の例を図\ref{fig:model_asset_survival}に示す．三種類の分布が見られ，

\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.8\linewidth]{fig/asset_a012_b02.pdf}
    \includegraphics[width=0.8\linewidth]{fig/asset_a003_b01.pdf}
    \includegraphics[width=0.8\linewidth]{fig/asset_a05_b05.pdf}
    \caption{資産の相補累積分布関数(a)ファット・テール分布, (b)正規分布，(c)段々になっている分布．}
